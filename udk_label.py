...
from view.libs.combobox import ComboBox
from view.libs.constants import *
from view.libs.utils import *
from view.libs.settings import Settings
from view.libs.shape import Shape, DEFAULT_LINE_COLOR, DEFAULT_FILL_COLOR
from view.libs.stringBundle import StringBundle
from view.libs.canvas import Canvas
from view.libs.zoomWidget import ZoomWidget
from view.libs.labelDialog import LabelDialog
from view.libs.colorDialog import ColorDialog
from view.libs.labelFile import LabelFile, LabelFileError, LabelFileFormat
from view.libs.toolBar import ToolBar
from view.libs.pascal_voc_io import PascalVocReader
from view.libs.pascal_voc_io import XML_EXT
from view.libs.yolo_io import YoloReader
from view.libs.yolo_io import TXT_EXT
from view.libs.ustr import ustr
from view.libs.hashableQListWidgetItem import HashableQListWidgetItem
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None):
        ...
        openNextImg = action(getStr('nextImg'), self.openNextImg, 'd', 'next', getStr('nextImgDetail'))
        ...
        self.engine_progress = QLabel('')
        self.statusBar().addPermanentWidget(self.labelCoordinates)
        self.statusBar().addPermanentWidget(self.engine_progress)
    ...
    def showInfoDialog(self):
        from view.libs.__init__ import __version__
    ...
    def loadFile(self, filePath=None):
        ...
        if unicodeFilePath and self.unconfirmedFileListWidget.count() > 0:
            if unicodeFilePath in self.uImgList:
                ...
                fileWidgetItem.setSelected(True)
                self.unconfirmedFileListWidget.scrollToItem(fileWidgetItem, QAbstractItemView.PositionAtCenter)
            else:
...
def get_main_app(argv=[]):
    ...
    # Usage : udk_label.py image predefClassFile saveDir
